...
{
    // ----------------------------------------------------------------- 1. Gear type & rating
    [Category("1. Gear type and rating basics")]
    ...
    [Category("3. Common outer geometry")]
    ...
    // ----------------------------------------------------------------- 4. Pinion geometry
    [Category("4. Pinion geometry (Annex C(M) initial data)")]
    ...
    // ----------------------------------------------------------------- 5. Gear geometry
    [Category("5. Gear geometry (Annex C(M) initial data)")]
    ...
    [Category("6. Geometry factors I (Zi), J (YJ) - clause 15")]
    ...
    [Category("7. Overload and dynamic factor")]
    ...
    [Category("8. Service factors (optional, clause 9)")]
    ...
    [Category("9. Load distribution factor, Km (KHβ) - clause 12")]
