...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        exampleComboBox.Items.AddRange(new object[] { "Annex E — Worked example (manual I/J)" });
        exampleComboBox.Location = new Point(123, 7);
        exampleComboBox.Name = "exampleComboBox";
        exampleComboBox.Size = new Size(320, 23);
        exampleComboBox.TabIndex = 1;
        //
        // loadExampleButton
        //
        loadExampleButton.Location = new Point(449, 7);
        ...
        // saveReportButton
        //
        saveReportButton.Location = new Point(565, 7);
        ...
        Text = "ANSI/AGMA 2003-D19 — Bevel Gear Pitting Resistance and Bending Strength Calculator";
